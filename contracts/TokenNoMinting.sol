...
contract TokenNoMinting is Context, IBEP20, Initializable {
     ...
     */
    function initialize(string memory name_, string memory symbol_, uint8 decimals_, uint256 amount, bool mintable_, address owner) public initializer {
        _owner = owner;
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
